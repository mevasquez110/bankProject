...
/**
 * CustomerService provides the service layer for handling customer-related
 * operations. This interface defines methods for creating a customer, getting
 * customer details by document number, finding all customers, updating a
 * customer, and deleting a customer.
 */
...
public interface CustomerService {
	 ...
	 *
	 * @param documentNumber     The document number of the customer to update
	 * @param contactDataRequest The request containing updated contact details
	 ...
	 * Deletes a customer.
	 *
	 * @param documentNumber The document number of the customer to delete
	 */
