...
public interface CreditCardService {
     ...
     *
     * @param creditCardRequest The request containing details necessary to create a new credit card
     * @return The response containing detailed information about the created credit card
     */
     ...
     * @return The response containing detailed information about the credit card debt
     */
     ...
     *
     * @return A list of responses containing detailed information about all credit cards
     */
     ...
     * @return The response containing detailed information about the updated credit card
     */
     ...
     *
     * @param consumptionRequest The request containing details about the consumption to be charged
