...
/**
 * YankiService is the interface that provides methods for handling Yanki-related operations. 
 * This includes creating Yanki entities, finding all Yanki entities, updating Yanki entities, 
 * and deleting Yanki entities.
 */
public interface YankiService {
     ...
     *
     * @param yankiRequest the Yanki request containing the details for creating the Yanki entity
     ...
     * @param yankiUpdateRequest the request containing details for updating the Yanki entity
