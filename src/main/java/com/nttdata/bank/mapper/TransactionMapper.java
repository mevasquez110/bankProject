...
/**
 * TransactionMapper provides mapping methods to convert between
 * TransactionRequest, TransactionEntity, and TransactionResponse objects. This
 * class includes methods to map a TransactionRequest to a TransactionEntity and
 * to map a TransactionEntity to a TransactionResponse.
 */
