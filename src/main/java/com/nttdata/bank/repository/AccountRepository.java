...
/**
 * AccountRepository provides CRUD operations for AccountEntity. This 
 * interface extends ReactiveMongoRepository and defines custom query methods 
 * to find active accounts by customer ID, account number, and account ID.
 */
public interface AccountRepository extends ReactiveMongoRepository<AccountEntity, String> {

    /**
     * Finds an active account that contains the given document number in the 
     * list of holder documents.
     *
     ...
     * @return A Mono emitting a boolean indicating if the account meets the criteria.
     */
