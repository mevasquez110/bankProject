...
/**
 * YankiRequest is a data transfer object that represents the request 
 * payload for creating or updating a Yanki entity. This class includes 
 * attributes such as name, phone number, document type, and document number.
